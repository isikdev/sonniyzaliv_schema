<?php
    ...
    $title = 'Рускеала - самый популярный горный парк в Карелии | Сонный Залив';
    $descr = 'Удивительный эко-парк рядом с г. Сортавала. Экскурсии по глубоким штольням и подземные пещеры с вагонетками и сталактитами запомнятся вам до следующего приезда в Рускеала';
    $keywords = 'Сонный Залив, Рускеала, эко-парк, экскурсия, Сортавала, штольни и подземные пещеры, горный парк, снять дом, аренда дома Сортавала, катера Сортавала';
...
<head>
    ...
    <link rel="canonical" href="https://sonniyzaliv.ru/ruskeala-gorniy-park"/>
...
<!-- END nav -->
<main role="main">
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/other/1.webp');" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center" style="margin-top: 100px;">
              <h1 id="act-form" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Рускеала - самый популярный горный парк в Карелии</h1>
              <?php echo $iconBlock ?>
          </div>
        ...
        <div class="container">
            <div class="row d-flex">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
                    <h2 class="mb-4">О горном парке Рускеала в Карелии</h2>
                    <p>Информация, которая будет Вам полезна при выборе места для отдыха</p>
                </div>
            </div>
            <div class="col-md-12 heading-section ftco-animate">
                <p class="color-black">Удивительный эко-парк рядом с г. Сортавала, созданный на месте заброшенных каменоломен 18-19 века.
                    Камень, который добывали здесь, отправляли в Санкт-Петербург для строительства особняков и дворцов. </p>
                <p class="color-black">Экскурсии по глубоким штольням и подземные пещеры с вагонетками и сталактитами запомнятся вам до следующего приезда в Рускеала.
                    Сюда всегда хочется вернуться!</p>
                <div class="row d-flex pt-3 pb-5">
                    <img class="col-md-12 ftco-animate" src="images/other/7.webp" alt="Рускеала 1">
                    <img class="col-md-12 ftco-animate" src="images/other/2.webp" alt="Рускеала 2">
                        <img class="col-md-12 ftco-animate" src="images/other/18.webp" alt="Рускеала 18">
                            <img class="col-md-12 ftco-animate" src="images/other/19.webp" alt="Рускеала 19">
                </div>
                <p class="color-black">Летом и осенью обязательно стоит попробовать спуски на подвесном троллее над мраморным каньоном
                    и прогулки на лодке по прозрачному озеру.</p>
                <p class="color-black">Снять дом в Рускеала сложно, лучше рекомендуем остановиться в Сортавала в 30 минутах от горного парка
                    для спокойного отдыха на берегу</p>
            </div>
            <div class="row d-flex">
            ...
            <div class="col-md-12 heading-section ftco-animate pt-5">
                <p class="color-black">Рускеальский экспресс - старинный ретропоезд (отправляется от железнодорожного вокзала в г. Сортавала и идет в Рускеала) на паровой тяге с
                    настоящим углем в котлах и вагоны стилизованные под 19 век запомнятся и взрослым и детям. Красивые виды
                    Карелии и вкусный завтрак со свежей газетой разнообразят путешествие.</p>
                <div class="row d-flex pt-3 pb-5">
                    <img class="col-md-12 ftco-animate" src="images/other/4.webp" alt="Рускеала 3">
                    <img class="col-md-12 ftco-animate" src="images/other/3.webp" alt="Рускеала 4">
                    <img class="col-md-12 ftco-animate" src="images/other/17.webp" alt="Рускеала 17">

                </div>
                <p class="color-black">Билеты на Рускеальский экспресс можно приобрести заранее на сайте РЖД</p>
            </div>
            <div class="row d-flex">
            ...
            <div class="col-md-12 heading-section ftco-animate pt-5">
                <p class="color-black">Также можно доехать Сортавала – Рускеала на своем авто или такси.</p>
            </div>
        </div>
    </section>
...
<script type="application/ld+json">{
    ...
    "@type": "WebPage",
    "url": "https://sonniyzaliv.ru/ruskeala-gorniy-park",
    "name": "Рускеала - самый популярный горный парк в Карелии | Сонный Залив",
    "description": "Удивительный эко-парк рядом с г. Сортавала. Экскурсии по глубоким штольням и подземные пещеры с вагонетками и сталактитами запомнятся вам до следующего приезда в Рускеала",
    "inLanguage": "ru-RU",
    "publisher": {
        "@type": "Organization",
        "name": "Сонный Залив",
