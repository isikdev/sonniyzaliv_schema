<?php
    ...
    $title = 'Прозрачный берег - гостевые дома  в Карелии | Сонный Залив Сортавала';
    $descr = 'Прозрачный берег дома в Сортавала, аренда Прозрачный берег, база Прозрачный берег, Прозрачный берег Суйстамо 60, Прозрачный берег Сортавала';
    $keywords = 'Прозрачный берег дома в Сортавала, аренда Прозрачный берег, база Прозрачный берег, Прозрачный берег Суйстамо 60, Прозрачный берег Сортавала, Сортавала снять дом, горный парк, снять дом Карелия, аренда дома Сортавала, катера Сортавала';
...
<!-- END nav -->
<main role="main">
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/prozrachniy/10.webp');" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center" style="margin-top: 100px;">
              <h1 id="act-form" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Прозрачный берег - дома с собственным пляжем в 60 км от Сортавала. поселок Суйстамо</h1>
              <?php echo $iconBlock ?>
          </div>
        ...
        <div class="container">
            <div class="row d-flex">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
                    <h2 class="mb-4">Прозрачный берег</h2>
                    <p>Информация, которая будет Вам полезна при выборе места для отдыха</p>
                </div>
            </div>
            <div class="col-md-12 heading-section ftco-animate">
                <p class="color-black">Новые гостевые дома расположились у озера СуйстамоЯрви в поселке Суйстамо в 60 км от Сортавала на самом берегу.</p>
                <p class="color-black">Дома со всем необходимым для отдыха от города.
Компании от 2 до 8 гостей сможет  разместиться в домах. </p>
                <div class="row d-flex pt-3 pb-5">
                    <img class="col-md-12 ftco-animate" src="images/prozrachniy/1.webp" alt="Прозрачный берег 1">
                    <img class="col-md-12 ftco-animate" src="images/prozrachniy/2.webp" alt="Прозрачный берег 2">
                    <img class="col-md-12 ftco-animate" src="images/prozrachniy/9.webp" alt="Прозрачный берег 3">
                    
                        <img class="col-md-12 ftco-animate" src="images/prozrachniy/4.webp" alt="Прозрачный берег 4">
                        <img class="col-md-12 ftco-animate" src="images/prozrachniy/11.webp" alt="Прозрачный берег 11">
                        <img class="col-md-12 ftco-animate" src="images/prozrachniy/back1.webp" alt="Прозрачный берег 12">
                            <img class="col-md-12 ftco-animate" src="images/prozrachniy/5.webp" alt="Прозрачный берег 5">
                </div>
                <p class="color-black">Предлагаются дома нескольких размеров 70, 70, 70, 50 квадратных метров в комфортном  ценовом диапазоне для любого бюджета. .</p>
              
                <p class="color-black">Отдельностоящий дом с мангальной зоной и видом на залив в распоряжении гостей. Дома работают круглый год.
Баня на берегу располагает к комфортному отдыху от города. Террасы с видом на закатный залив позволяют забыть о городском ритме и насладиться размеренным течением времени в Карелии.</p>
            </div>
            <div class="row d-flex">
            ...
            <div class="col-md-12 heading-section ftco-animate pt-5">
                <p class="color-black">Для малышей оборудована игровая площадка с  качелями.
Подход к воде с небольшим оборудованным пляжем находится всего в 50 метрах.</p>
                <div class="row d-flex pt-3 pb-5">
                    <img class="col-md-12 ftco-animate" src="images/prozrachniy/6.webp" alt="Прозрачный берег 6">
                    <img class="col-md-12 ftco-animate" src="images/prozrachniy/7.webp" alt="Прозрачный берег 7">    
                    <img class="col-md-12 ftco-animate" src="images/prozrachniy/8.webp" alt="Прозрачный берег 8">
                    <img class="col-md-12 ftco-animate" src="images/prozrachniy/9.webp" alt="Прозрачный берег 9">
       
                    
                </div>
            
                <p class="color-black">Возможно платное размещение с животными с разовым сбором. Возможна аренда лодок и сап досок.
 Цены от 11.800 в  высокий сезон. Новогодние праздники, как правило, дороже. Бронируют новый год с сентября, на летний сезон продажи открываются в декабре-январе.</p>
            </div>
                 <div class="row d-flex">
                <div class="conf-btn" style="padding-top: 5px;"><a href="#" <?/*id="reserve1" */?> data-tl-booking-open="true" class="btn btn-primary py-3 px-4 ftco-animate"><i class="ion-ios-calendar"></i> Забронировать</a></div>
            </div>
...
<script type="application/ld+json">{
    ...
    "@type": "WebPage",
    "url": "https://sonniyzaliv.ru/prozrachniy-bereg.php",
    "name": "Прозрачный берег - гостевые дома  в Карелии | Сонный Залив Сортавала",
    "description": "Прозрачный берег дома в Сортавала, аренда Прозрачный берег, база Прозрачный берег, Прозрачный берег Суйстамо 60, Прозрачный берег Сортавала",
    "inLanguage": "ru-RU",
    "publisher": {
        "@type": "Organization",
        "name": "Сонный Залив",
