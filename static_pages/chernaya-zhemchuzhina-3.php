<?php 
	...
	$title = 'Черная жемчужина №3 - гостевой дом на базе в Сортавала на  берегу озера в республике Карелия. Аренда коттеджа Черная жемчужина №3 посуточно в республике Карелия г. Сортавала';
	$descr = 'Мы предлагаем Вам снять дом Черная жемчужина №3 на базе с видом на озеро и всеми удобствами в Карелии г. Сортавала. Арендовать коттедж Черная жемчужина №3 на сутки в республике Карелия Сонный Залив. Уютный большой дом Черная жемчужина №3 на берегу озера. Арендуйте дом Черная жемчужина №3 возле озера на сутки в республике Карелия по цене от 6500 тыс. руб.';
	$keywords = 'база отдыха Сортавала, Черная жемчужина Сортавала, снять коттедж на сутки в республике Карелия, аренда коттеджа посуточно в республике Карелия, аренда дома с видом на озеро, отдых в Карелии, снять дом с видом на озеро, база Сортавала, база в Карелии, дом с лодками';
...
<script>
  ...
  <body>
    ...
    <!-- END nav -->
    <main role="main">
		<div class="js-fullheight" id="main-photo">
            <div class="flexslider">
                <ul class="slides">
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina/zima/4.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina/zima/3.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina/zima/1.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina/4.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina/9.webp);" data-stellar-background-ratio="0.5"></li>
                </ul>
                  ...
                  <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                      <div class="col-md-9 text text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                         ...
                         <h1 id="act-form" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">"Черная жемчужина №3"</h1>
                         <h2 class="subtext" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Аренда гостевого дома "Черная жемчужина №3" в Карелии. Актуальные цены, подробное описание, фотографии, контакты</h2>
                         <?php echo $iconBlock; ?>
                      </div>
                            ...
                            <div class="col-md-12 heading-section ftco-animate">
                                ...
                                <div class="col-md-12 justify-content-center counter-wrap ftco-animate" style="padding-top: 22px">
                                    <div class="block-18 text-center mb-4">
                                        <div class="text">
                                            <strong style="font-size: 22px; color: #323232;">"Будем рады встретить гостей в новом туристическом уголке "Черная жемчужина №3". Лес, Ладога, лодки, снегоходы. Уютные, теплые дома ждут вас</strong>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row justify-content-center pb-4">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <p>Ниже, представлены актуальные цены на бронирование гостевого дома "Черная жемчужина №3"</p>
                    </div>
                </div>
                <div class="row">
        ...
        <section id="houseBooking" class="ftco-section ftco-no-pb ftco-no-pt bg-light" style="background: #f9fafb; z-index: 1">
            <div class="container">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate" style="padding-top: 60px;">
                    ...
                    <p>Для бронирования гостевого дома "Черная жемчужина №3" заполните форму ниже</p>
                </div>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <form action="#" class="search-property-1">
                                <div class="row">
                                        ...
                                        <div class="form-group" style="text-align: center;">
                                            ...
                                            <div class="sel sel--black-panther">
                                                <select name="select-profession" id="select-profession">
                                                    ...
                                                    <option value="14" name="select-profession-option">Черная жемчужина №3</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg align-self-end">
                                        <div class="form-group">
                                            <div class="form-field">
                                                <button type="button" id="sendAppBtn" onclick="sendApplication(this)" hid="14" class="form-control btn btn-primary"><i class="ion-ios-checkmark-circle"></i> Забронировать</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row block-9">
                  <div class="col-md-6 d-flex ftco-animate">
                      <div style="overflow:hidden;width:100%;height:90%;">
                          ...
                          <a href="https://yandex.ru/maps/10933/republic-of-karelia/house/posyolok_lamberg_1/Z0kYcQJgSkMCQFhrfXp5cHhkZQ==/?ll=30.750365%2C61.681471&utm_medium=mapframe&utm_source=maps&z=17.14" style="color:#eee;font-size:12px;position:absolute;top:14px;">Посёлок Ламберг, 1 — Яндекс Карты</a>
                          <iframe src="https://yandex.ru/map-widget/v1/-/CCUjuTWjLB" width="540" height="540" frameborder="0" allowfullscreen="true" style="position:relative;width:100%;"></iframe>
                      </div>
                  </div>
    ...
    "@type": "WebPage",
    "url": "https://sonniyzaliv.ru/chernaya-zhemchuzhina-3.php",
    "name": "Черная жемчужина №3 - гостевой дом на базе в Сортавала на  берегу озера в республике Карелия. Аренда коттеджа Черная жемчужина №3 посуточно в республике Карелия г. Сортавала",
    "description": "Мы предлагаем Вам снять дом Черная жемчужина №3 на базе с видом на озеро и всеми удобствами в Карелии г. Сортавала. Арендовать коттедж Черная жемчужина №3 на сутки в республике Карелия Сонный Залив. Уютный большой дом Черная жемчужина №3 на берегу озера. Арендуйте дом Черная жемчужина №3 возле озера на сутки в республике Карелия по цене от 6500 тыс. руб.",
    "inLanguage": "ru-RU",
    "publisher": {
        "@type": "Organization",
        "name": "Сонный Залив",
