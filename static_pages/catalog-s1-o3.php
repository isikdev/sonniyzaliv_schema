<?php
	...
	$title = 'Сонный Залив - Каталог загородных домов в республике Карелия. Список коттеджей посуточно в республике Карелия г. Сортавала';
	$descr = 'Гостиница в Видлице, Олонецкий район, Парк Отель Кружево
Гостиница в Карелии на берегу Ладожского озера, Парк Сортавала
Гостиница в Лодейном Поле, Пороги Лосево
Гостевой дом Остров, Приозерск рестораны
Гостевой дом Тихотут, Сонный залив
Забронировать домик в Карелии, Северное сияние в Сортавале
Загородный отель Карелия, Сеть отелей Точка на Карте
Загородный отель Кружево в Сортавале, Ягоды, которые растут в Карелии
';
    ...
    $housesSlider = initHousesSlider(-1, "Наши дома");
    $iconBlock = getSubscribeIconBlock();
    $catalog = initCatalogHouses(false, 1);
    $subsMenu = getSubscribeMenu();
    $footer = getFooter();
?>
<!DOCTYPE html>каталог
...
<body>
            ...
            <div class="container">
                <div class="row justify-content-center pb-4" id="section-catalog">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        <h2 class="mb-4">Подборка домов с сауной</h2>
            ...
            <div class="cd-tab-filter-wrapper">
                <div class="cd-tab-filter">
                    <ul class="cd-filters" id="catalog-list">
                        ...
                        <li class="filter"><a onclick="useFilter(this)" value="0" class="selected" href="#0">Все</a>
                        </li>
                ...
                <form>
                    <div class="cd-filter-block">
                        ...
                        <div class="cd-filter-content">
                            <input type="date" placeholder="Выберите дату" class="catalog-date" id="date-in"
                                onchange="useFilter();">
                    ...
                    <div class="cd-filter-block">
                        <h4>Дата выезда</h4>
                        <div class="cd-filter-content">
                            <input type="date" placeholder="Выберите дату" class="catalog-date" id="date-out"
                                onchange="useFilter();">
                        </div> <!-- cd-filter-content -->
                    </div> <!-- cd-filter-block -->
                    <div class="cd-filter-block">
    ...
    "@type": "WebPage",
    "url": "https://sonniyzaliv.ru/catalog-s1-o3.php",
    "name": "Сонный Залив - Каталог загородных домов в республике Карелия. Список коттеджей посуточно в республике Карелия г. Сортавала",
    "description": "",
    "inLanguage": "ru-RU",
    "publisher": {
        "@type": "Organization",
