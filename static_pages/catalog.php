...
<html lang="ru" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#">
  <head>
	...
	<meta property="og:image" content="images/logo.png">
      ...
      <link rel="canonical" href="https://sonniyzaliv.ru/catalog"/>
  ...
  <body>
    ...
    <main role="main">
        <section class="ftco-section services-section" style="padding-bottom: 0">
            ...
            <a target="_blank" id="hotels101_partner_widget_729" style="text-decoration: none; display: block; width: 200px; height: 80px;center" href="https://101hotels.com/main/cities/sortavala/gostevoy_dom_sonniy_zaliv.html">

            </a>
            <script>
                (function() {
                    var script   = document.createElement('script'), generated_id = 729;
                    script.type  = 'text/javascript';
                    script.async = true;
                    script.src   = 'https://101hotels.com/widget/generator/' + generated_id + '/665435/t-4/opacity-hover';
...
<!--                </div>-->
    ...
    "@type": "WebPage",
    "url": "https://sonniyzaliv.ru/catalog",
