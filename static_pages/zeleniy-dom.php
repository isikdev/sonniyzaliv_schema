<?php
	...
	$title = 'Спящий залив Зелёный дом - снять уютный, новый, современный коттедж 90 кв.м. с террасой 25 кв.м. на берегу Ладожского озера на острове Риеккалансаари в пяти минутах от г. Сортавала. Аренда коттеджа Зелёный дом';
	$descr = 'Мы предлагаем Вам снять дом Зелёный дом Спящий залив с панорамным видом на озеро и всеми удобствами в Карелии г. Сортавала. Арендовать коттедж Зелёный дом на сутки в республике Карелия Сонный Залив. Уютный большой дом Зелёный дом на берегу озера. Арендуйте дом Зелёный дом на сутки в республике Карелия по цене от 8000 рублей в сутки';
	$keywords = 'Спящий залив снять коттедж на сутки в республике Карелия, аренда коттеджа посуточно в республике Карелия, аренда дома с панорманым видом на озеро, отдых в Карелии, снять дом с видом на озеро, снять дом в Сортавала, аренда дома Сортавала, аренда дача Сортавала';
...
<html lang="ru" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#" class="tl-html">
  <head>
	...
	<meta property="og:image" content="images/logo.png">
      ...
      <link rel="canonical" href="https://sonniyzaliv.ru/zeleniy-dom"/>
...
<!--</script>-->
  ...
  <body>
    ...
    <main role="main">
		<div class="js-fullheight" id="main-photo" style="background: #f9fafb;">
            <div class="flexslider">
                <ul class="slides">
                    <li style="background-image: url(images/houses/zeleniy-dom/leto/1.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/zeleniy-dom/leto/2.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/zeleniy-dom/5.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/zeleniy-dom/18.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/zeleniy-dom/leto/5.webp);" data-stellar-background-ratio="0.5"></li>
                </ul>
                  ...
                  <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                      <div class="col-md-9 text text-center ftco-animate" style="margin-top: 100px;" data-scrollax=" properties: { translateY: '70%' }">
                         <h1 id="act-form" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Зелёный дом</h1>
                         <h2 class="subtext" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Аренда гостевого дома "Зелёный дом" в Спящем заливе. Актуальные цены, подробное описание, фотографии, контакты</h2>
                         <?php echo $iconBlock; ?>
                      </div>
            ...
            <div class="container">
                <div class="row d-flex" id="aboutUs">
                    <div class="col-md-6 d-flex">
                        <div class="img d-flex align-self-stretch" style="background-image:url(images/houses/zeleniy-dom/person.webp);"></div>
                    </div>
                    <div class="col-md-6 pl-md-5 py-5">
                        <div class="row justify-content-start pb-3">
                            <div class="col-md-12 heading-section ftco-animate">
                                <h2 class="mb-4">Алексей - владелец "Зелёный дом в Спящем заливе"</h2>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
                        ...
                        <p>"Зелёный дом" оборудован всей необходимой техникой и инженерным оборудованием для вашего комфортного отдыха:</p>
                    </div>
                    <div class="col-md-12">
                        <div class="row">
            ...
            <div class="container">
                <div class="row justify-content-center pb-4">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <p>Ниже, представлены актуальные цены на бронирование гостевого дома "Зелёный дом"</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 ftco-animate">
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                ...
                                <p class="location"><span class="flaticon-settings"></span> В стоимость проживания входит: постельное белье, полотенца. сауна, мангал, шампуры</p>
                                <p class="location"><span class="flaticon-settings"></span> Проживание с домашними питомцами 2000 руб. за весь период.</p>
                                <p class="location"><span class="flaticon-settings"></span> Предоплата 30%, на праздники 50% (НГ, 8 марта, 23 февраля, 1-9 мая, 12 июня, 4 ноября).</p>
                                <p class="location"><span class="flaticon-settings"></span> Залог за сохранность имущества 5000 руб, если с собакой 10000 руб. Возвращается при выезде.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 ftco-animate">
                        <div class="project-wrap">
                            <a class="img scroll-elem" style="background-image: url(images/karelia-9.webp);"></a>
                            <div class="text p-4">
                                <span class="price">12900 руб/сут</span>
                                <span class="days">от 2 суток</span>
                                <h3><a class="scroll-elem">"Майские праздники"</a></h3>
                                <p class="location"><span class="flaticon-settings"></span> ночи: пн-пн</p>
                                <p class="location"><span class="flaticon-settings"></span> В стоимость проживания входит: постельное белье, полотенца. сауна, мангал, шампуры</p>
                                <p class="location"><span class="flaticon-settings"></span> Проживание с домашними питомцами 2000 руб. за весь период.</p>
                                <p class="location"><span class="flaticon-settings"></span> Предоплата 30%, на праздники 50% (НГ, 8 марта, 23 февраля, 1-9 мая, 12 июня, 4 ноября).</p>
                    ...
                    <div class="col-md-6 ftco-animate">
                        <div class="project-wrap">
                            <a class="img scroll-elem" style="background-image: url(images/karelia-1.webp);"></a>
                            <div class="text p-4">
                                <span class="price">16000 руб/сут</span>
                                <span class="days">от 2 суток</span>
                                <h3><a class="scroll-elem">"Июнь"</a></h3>
                                <p class="location"><span class="flaticon-settings"></span> ночи: пн-пн</p>
                                <p class="location"><span class="flaticon-settings"></span> В стоимость проживания входит: постельное белье, полотенца. сауна, мангал, шампуры</p>
                                <p class="location"><span class="flaticon-settings"></span> Проживание с домашними питомцами 2000 руб. за весь период.</p>
                                <p class="location"><span class="flaticon-settings"></span> Предоплата 30%, на праздники 50% (НГ, 8 марта, 23 февраля, 1-9 мая, 12 июня, 4 ноября).</p>
                    ...
                    <div class="col-md-6 ftco-animate">
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                <span class="price">12900 руб/сут</span>
                                <span class="days">от 2 суток</span>
                                <h3><a class="scroll-elem">"С 03.11 по 06.11"</a></h3>
                                <p class="location"><span class="flaticon-settings"></span> ночи: пн-пн</p>
                                <p class="location"><span class="flaticon-settings"></span> В стоимость проживания входит: постельное белье, полотенца. сауна, мангал, шампуры</p>
                                <p class="location"><span class="flaticon-settings"></span> Проживание с домашними питомцами 2000 руб. за весь период.</p>
                                <p class="location"><span class="flaticon-settings"></span> Предоплата 30%, на праздники 50% (НГ, 8 марта, 23 февраля, 1-9 мая, 12 июня, 4 ноября).</p>
                    ...
                    <div class="col-md-6 ftco-animate">
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                <span class="price">30000 руб/сут</span>
                                <span class="days">от 2 суток</span>
                                <h3><a class="scroll-elem">"Новый год"</a></h3>
                                <p class="location"><span class="flaticon-settings"></span> ночи: с 30.12.2022 по 10.01.2023</p>
                                <p class="location"><span class="flaticon-settings"></span> В стоимость проживания входит: постельное белье, полотенца. сауна, мангал, шампуры</p>
                                <p class="location"><span class="flaticon-settings"></span> Проживание с домашними питомцами 2000 руб. за весь период.</p>
                                <p class="location"><span class="flaticon-settings"></span> Предоплата 30%, на праздники 50% (НГ, 8 марта, 23 февраля, 1-9 мая, 12 июня, 4 ноября).</p>
                                <p class="location"><span class="flaticon-settings"></span> Залог за сохранность имущества 5000 руб, если с собакой 10000 руб. Возвращается при выезде.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="ftco-animate">
                                <div class="project-destination">
                                    <a class="img" style="background-image: url(images/houses/zeleniy-dom/28.webp);" href="images/houses/zeleniy-dom/28.webp" data-fancybox="gallery-boat">
                                        <div class="text">
                                        </div>
                                    </a>
                                </div>
            ...
            <div class="container">
                <div class="row justify-content-center pb-4">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <p>Ниже, представлены некоторые интересные особенности гостевого дома "Зелёный дом"</p>
                    </div>
                </div>
                <div class="row">
        ...
        <section id="houseReviews" style="background: url(images/houses/zeleniy-dom/2.webp);" class="ftco-section services-section module bg-dark-60 pt-0 pb-0 parallax-bg testimonial ftco-animate">
            <div class="container">
                ...
                <ul class="slides">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-8 offset-sm-2">
                                    <blockquote class="testimonial-text font-alt">Отличное место для отдыха! Красивый большой удобный дом с красивым видом!!
                                        Все необходимое для проживания имеется! Тишина и карельские красоты!!
                                        Обязательно помимо зимы нужно приехать ещё летом что бы почувствовать все ощущения полностью!!! Отдых на 10+!!!!!!!!
                                    </blockquote>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4 offset-sm-4">
                                    <div class="testimonial-author">
                                        <div class="testimonial-caption font-alt">
                                            ...
                                            <div class="testimonial-descr">20 февраля 2022</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <li>
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-8 offset-sm-2">
                                    <blockquote class="testimonial-text font-alt">Дом чудесный, уютный, есть всё необходимое для комфортного проживания.
                                        Прекрасное местоположение, рядом озеро, лес, красота! Алексей очень гостеприимный хозяин! Обязательно приедем ещё ! Рекомендую!
                                    </blockquote>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4 offset-sm-4">
                                    <div class="testimonial-author">
                                        <div class="testimonial-caption font-alt">
                                            ...
                                            <div class="testimonial-descr">15 февраля 2022</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <li>
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-8 offset-sm-2">
                                    <blockquote class="testimonial-text font-alt">Чистый современный уютный дом, сделанный со вкусом как для себя без пошлых элементов дизайна.
                                        Была отлично расчищенная от снега дорога, не сравнить с СПб. Все хорошо работает, даже интернет неплохой для такой дали.
                                        Алексей заботится о каждой мелочи. Спасибо за отличный отдых!
                                    </blockquote>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4 offset-sm-4">
                                    <div class="testimonial-author">
                                        <div class="testimonial-caption font-alt">
                                            ...
                                            <div class="testimonial-descr">5 февраля 2022</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="houseBooking" class="ftco-section ftco-no-pb ftco-no-pt bg-light" style="background: #f9fafb; z-index: 1">
            <div class="container">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate" style="padding-top: 60px;">
                    ...
                    <p>Для бронирования гостевого дома "Зелёный дом" заполните форму ниже</p>
                </div>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <form action="#" class="search-property-1">
                                <div class="row">
                                        ...
                                        <div class="form-group" style="text-align: center;">
                                            ...
                                            <div class="sel sel--black-panther">
                                                <select name="select-profession" id="select-profession">
                                                    ...
                                                    <option value="6" name="select-profession-option">Зелёный дом</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg align-self-end">
                                        <div class="form-group">
                                            <div class="form-field">
                                                <button type="button" id="sendAppBtn" onclick="sendApplication(this)" hid="6" class="form-control btn btn-primary"><i class="ion-ios-checkmark-circle"></i> Забронировать</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
			...
			<div class="row d-flex contact-info">
			  <div class="col-md-3 d-flex ftco-animate">
				<div class="align-self-stretch box p-4 text-center">
					...
					<p>Россия, Республика Карелия, Сортавальское городское поселение, п. Нукутталахти, ул. Центральная, д. 60</p>
				  </div>
			  </div>
			  <div class="col-md-3 d-flex ftco-animate">
				<div class="align-self-stretch box p-4 text-center">
    ...
    "@type": "Product",
    "url": "https://sonniyzaliv.ru/zeleniy-dom",
    "name": "Спящий залив Зелёный дом - снять уютный, новый, современный коттедж 90 кв.м. с террасой 25 кв.м. на берегу Ладожского озера на острове Риеккалансаари в пяти минутах от г. Сортавала. Аренда коттеджа Зелёный дом",
    "description": "Мы предлагаем Вам снять дом Зелёный дом Спящий залив с панорамным видом на озеро и всеми удобствами в Карелии г. Сортавала. Арендовать коттедж Зелёный дом на сутки в республике Карелия Сонный Залив. Уютный большой дом Зелёный дом на берегу озера. Арендуйте дом Зелёный дом на сутки в республике Карелия по цене от 8000 рублей в сутки",
    "inLanguage": "ru-RU",
    "offers": {
        "@type": "Offer",
        "priceCurrency": "RUB",
