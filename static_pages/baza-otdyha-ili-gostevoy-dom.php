<?php
    ...
    $title = 'База отдыха в Карелии или гостевой дом | Сонный Залив';
    $descr = 'О наших гостевых домах. Интересные факты о Сонном Заливе';
    $keywords = 'Сонный Залив, гостевые дома, снять дом, аренда коттеджа, гостевая база, снять дом, база отдыха Сортавала, база отдыха Карелия, база отдыха на берегу, база отдыха';
...
<head>
    ...
    <link rel="canonical" href="https://sonniyzaliv.ru/baza-otdyha-ili-gostevoy-dom" />
...
<body>
    ...
    <!-- END nav -->
    <main role="main">
        <section class="hero-wrap hero-wrap-2 js-height 20%"
            style="background-image: url('images/articles/900back.webp');" data-stellar-background-ratio="0.3">
            <div class="container">
                <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate pb-5 text-center" style="margin-top: 100px;">
                        <h1 id="act-form" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">База отдыха в
                            Карелии или гостевой дом</h1>
                        <?php echo $iconBlock ?>
                    </div>
            ...
            <div class="container">
                <div class="row d-flex">
                    <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
                        <h2 class="mb-4">Гостевые дома и базы отдыха</h2>
                        <p>Информация, которая будет Вам полезна при выборе места для отдыха</p>
                    </div>
                </div>
                <div class="col-md-12 heading-section ftco-animate">
                    <p class="color-black">Когда ищешь аренду домика в Карелии, всегда задаешься вопросом, что же
                        выбрать: уютный,
                        отдельностоящий гостевой дом в Сортавала или остановиться на небольшой базе?</p>
                    <div class="row d-flex pt-3 pb-5">
                        <img class="col-md-12 ftco-animate" src="images/houses/chernika-v-sonnom-zalive/leto/15.webp"
                            alt="Гостевой дом Черника в заливе">
                    </div>
                    <p class="color-black">Небольшие базы отдыха у нас располагаются у воды, и рассмотреть аренду домика
                        следует в таких местах.
                        Отдых в Карелии должен ассоциироваться с берегом Ладожского озера и уютным, теплым домом.</p>
                    <p class="color-black">На фотографии выше - «Черника в Сонном заливе». Три новых дома в
                        скандинавском стиле встретят вас
                        в шикарном месте на большом острове Риеккалансаари в 5 километрах от центра города Сортавала</p>
                </div>
                <div class="row d-flex">
                    <div class="conf-btn" style="padding-top: 5px;"><a href="#" <?/*id="reserve1" */?>
                ...
                <div class="col-md-12 heading-section ftco-animate pt-5">
                    <p class="color-black">Небольшая база отдыха «Черная жемчужина» в Карелии в Сортавала –
                        это пять отдельных коттеджей для аренды, круглый год встречающих гостей в домиках для отдыха у
                        воды </p>
                    <div class="row d-flex pt-3 pb-5">
                        <img class="col-md-12 ftco-animate" src="images/other/15.webp"
                            alt="Гостевой дом Черная жемчужина">
                    </div>
                ...
                <div class="col-md-12 heading-section ftco-animate pt-5">
                    <p class="color-black">Если решили выбрать аренду домика у озера, для семьи или небольшой компании,
                        всегда лучше заблаговременно
                        найти для себя интересный дом. Дома с сауной или без нее, дома с ограждением для отдыха с
                        крупными питомцами или просто,
                        чтобы укрыться от лишний глаз и спокойно насладится загородным отдыхом.
                        Встречаются, очень интересные варианты с бассейном или уличной купелью.</p>
                    <div class="row d-flex pt-3 pb-5">
                        <img class="col-md-12 ftco-animate" src="images/other/14.webp" alt="Гостевой дом Сонный Залив">
                    </div>
                    <p class="color-black">На фото купель под открытым небом в «Лунном заливе» и дом «Сонный залив с
                        сауной и купелью»</p>
                </div>
                <div class="row d-flex">
                    <div class="conf-btn" style="padding-top: 5px;"><a href="#" <?/*id="reserve1" */?>
                ...
                <div class="col-md-12 heading-section ftco-animate pt-5">
                    <p class="color-black">Всегда есть выбор где остановиться, чтобы отдохнуть в Карелии.
                        Останавливайтесь в наших домах.</p>
                </div>
            </div>
        </section>
    ...
    "@type": "Product",
    "url": "https://sonniyzaliv.ru/baza-otdyha-ili-gostevoy-dom",
    "name": "База отдыха в Карелии или гостевой дом | Сонный Залив",
    "description": "О наших гостевых домах. Интересные факты о Сонном Заливе",
    "inLanguage": "ru-RU",
    "offers": {
        "@type": "Offer",
        "priceCurrency": "RUB",
    ...
    "image": [
        ...
        "https://sonniyzaliv.ru/images/other/15.webp",
        "https://sonniyzaliv.ru/images/other/14.webp",
