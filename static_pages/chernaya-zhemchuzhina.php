<?php
	...
	$title = 'Черная жемчужина 80м2 - забронировать онлайн дом на базе в Сортавала до 6 гостей. С панорамными окнами на залив. Аренда коттеджа "Черная жемчужина 80м2" посуточно в республике Карелия г. Сортавала';
	$descr = 'Мы предлагаем Вам снять дом "Черная жемчужина 80м2" на базе с видом на озеро и всеми удобствами в Карелии г. Сортавала. Арендовать коттедж "Черная жемчужина 80м2" на сутки в республике Карелия на Сонный Залив. Уютный большой дом "Черная жемчужина 80м2" на берегу озера. Арендуйте дом "Черная жемчужина 80м2" возле озера на сутки в республике Карелия по цене от 6500 тыс. руб.';
	$keywords = 'база отдыха Сортавала, снять коттедж на сутки в республике Карелия, аренда коттеджа посуточно в республике Карелия, аренда дома с видом на озеро, отдых в Карелии, снять дом с видом на озеро, снять дачу в Сортавала';
...
<head>
    ...
    <link rel="canonical" href="https://sonniyzaliv.ru/chernaya-zhemchuzhina" />
...
["mousemove", "touchstart", "scroll"].forEach(event => {
    document.addEventListener(event, loadGtag, {
        once: true
    });
});
...
<body>
    ...
    <main role="main">
        <div class="js-fullheight" id="main-photo" style="background: #f9fafb;">
            <div class="flexslider">
                <ul class="slides">
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina/zima/4.webp);"
                        data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina/5.webp);"
                        data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina/19.webp);"
                        data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina/1.webp);"
                        data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina/15.webp);"
                        data-stellar-background-ratio="0.5"></li>
                </ul>
                    ...
                    <div class="container">
                        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
                            ...
                            <div class="col-md-9 text text-center ftco-animate" style="margin-top: 100px;"
                                ...
                                <h1 id="act-form" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Черная
                                    жемчужина 80м2</h1>
                                <h2 class="subtext" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
                                    Аренда гостевого дома "Черная жемчужина 80м2" в Карелии. Актуальные цены, подробное
                                    описание, фотографии, контакты</h2>
                                <?php echo $iconBlock; ?>
                            </div>
                ...
                <div class="row d-flex">
                    <div class="col-md-6 d-flex">
                        <div class="img d-flex align-self-stretch"
                            style="background-image:url(images/houses/chernaya-zhemchuzhina/owner.webp); height: 600px;">
                        </div>
                    </div>
                            ...
                            <div class="col-md-12 heading-section ftco-animate">
                                ...
                                <div class="col-md-12 justify-content-center counter-wrap ftco-animate"
                                    ...
                                    <div class="block-18 text-center mb-4">
                                        <div class="text">
                                            <strong style="font-size: 22px; color: #323232;">"Будем рады встретить
                                                гостей в новом туристическом уголке "Черная жемчужина 80м2". Лес,
                                                Ладога, лодки, снегоходы. Уютные, теплые дома ждут вас</strong>
                                        </div>
                                    </div>
                                </div>
        ...
        <section id="aboutHome" class="ftco-section services-section bg-light" style="padding-bottom: 0">
            <div class="container">
                <div class="row d-flex">
                            ...
                            <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                                <div class="media block-6 services d-block">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>В доме расположены 2 полуторные кровати и 1 двуспальная</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                            ...
                            <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                                <div class="media block-6 services d-block">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>Просмотр телевизора со спутниковым телевидением и выходом в интернет на
                                            мягком диване</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="conf-btn"><a href="#" <?/*id="reserve1" */?> data-tl-booking-open="true" class="btn
                            btn-primary py-3 px-4 ftco-animate"><i class="ion-ios-calendar"></i> Забронировать</a></div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row justify-content-center pb-4">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <p>Ниже, представлены актуальные цены на бронирование гостевого дома "Черная жемчужина 80м2"</p>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="container">
                <div class="row d-flex">
                    <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
                        ...
                        <p>Чтобы Ваш отдых был еще более разнообразным и незабываемым, за дополнительную стоимость,
                            гостевой дом "Черная жемчужина" готов Вам предоставить:</p>
                    </div>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="media block-6 services d-block">
                ...
                <div class="row d-flex">
                    <div class="conf-btn" style="padding-top: 30px;"><a href="#" <?/*id="reserve1" */?>
                            data-tl-booking-open="true" class="btn btn-primary py-3 px-4 ftco-animate"><i
        ...
        <section id="houseRules" style="padding-top: 0" class="ftco-section services-section bg-light"
            style="padding-bottom: 0">
            <div class="container">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate"
                    style="padding-top: 60px;">
                    <h2 class="mb-4">Список правил</h2>
                    <p>Предлагаем Вам ознакомиться с <b>5-ю</b> нашими основными правилами бронирования, пребывания,
                        заезда и выезда:</p>
                </div>
                <div class="col-md-12">
                    <div class="row">
                ...
                <div class="row d-flex">
                    <div class="conf-btn" style="padding-top: 30px;">
                        <a href="#" <?/*id="reserve1" */?> data-tl-booking-open="true" class="btn btn-primary py-3 px-4
                            ftco-animate">
            ...
            <div class="container">
                <div class="row justify-content-center pb-4">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <p>Ниже, представлены некоторые интересные особенности гостевого дома "Чёрная жемчужина №1"</p>
                    </div>
                </div>
                <div class="row">
                    <div class="post-wrap ftco-animate">
                        ...
                        <div class="post-item">
                            <div class="item-content">
                                ...
                                <div class="item-body">
                                    <p>Также на территории есть два коттеджа по 40 м2 на 4 человека</p>
                                </div>
                            </div>
                        </div>
                        <div class="post-item">
                ...
                <div class="col-md-12 heading-section ftco-animate">
                    <p class="color-black">Обратите внимание на важное правило дома: при заезде гость вносит страховой
                        депозит за сохранность имущества в размере 5000.
                        Страховой депозит возвращается при выезде при условии сохранности имущества дома</p>
                    <p class="color-black">Новая небольшая база в Карелии. Три уютных НОВЫХ современных коттеджа по 80
                        кв.м. с террасой,
                        с панорамными окнами, с видом на озеро,на берегу Ладожского озера на острове Риеккалансаари в
                        пяти минутах от г. Сортавала!</p>
                    <p class="color-black">Две отдельных спальни и лофт, полностью оборудованная кухня, гостиная,
                        туалет, душ, телевизор, холодильник, микроволновая печь,
                        посудомоечная машина, стиральная машина, чайник, кофеварка, тостер, утюг. Есть вся посуда. </p>
                    <p class="color-black">В ста метрах от коттеджей находится база отдыха "Ламберг", где вы можете
                        посетить баню на воде, ресторан.
                        В зимнее время года покататься на снегоходах, оборудованная горка. Летом это рыбалка, поездка на
                        катерах по ладожским шхерам</p>
                    <p class="color-black">Окажем помощь в поездке на о. Валаам, водные экскурсии на ладожские шхеры на
                        комфортабельном катере.
        ...
        <section id="houseReviews" style="background: url(images/houses/chernaya-zhemchuzhina/zima/4.webp);"
        ...
        <section id="houseBooking" class="ftco-section ftco-no-pb ftco-no-pt bg-light"
            ...
            <div class="container">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate"
                    ...
                    <p>Для бронирования гостевого дома "Черная жемчужина 80м2" заполните форму ниже</p>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                        ...
                                        <div class="form-group" style="text-align: center;">
                                            ...
                                            <div class="sel sel--black-panther">
                                                <select name="select-profession" id="select-profession">
                                                    ...
                                                    <option value="12" name="select-profession-option">Черная жемчужина
                                                        80м2</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 align-items-end">
                                        <div class="form-group">
                                            ...
                                            <div class="form-field">
                                                ...
                                                <input type="number" min="1" max="5" id="personCount"
                                                    class="form-control" placeholder="Укажите число">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 align-items-end">
                                        <div class="form-group">
                                            ...
                                            <label class="toggle-item" for="cancelAgreement">
                                                <input type="checkbox" class="toggle-item__input"
                                                    id="cancelAgreement" />
                                            ...
                                            <div class="form-field">
                                                <button type="button" id="sendAppBtn" onclick="sendApplication(this)"
                                                    hid="12" class="form-control btn btn-primary"><i
                                                        class="ion-ios-checkmark-circle"></i> Забронировать</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                ...
                <div class="accordion-faq ftco-animate">
                    <div class="accordion-item">
                        <button id="accordion-button-4" aria-expanded="true"><span class="accordion-title">Входит ли
                                постельное белье в стоимость?</span><span class="icon"
                    ...
                    <div class="accordion-item">
                        <button id="accordion-button-5" aria-expanded="false"><span class="accordion-title">Можно ли
                                проехать на легковой машине на остров?</span><span class="icon"
                                aria-hidden="true"></span></button>
                        <div class="accordion-content">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <ul class="filter font-alt ftco-animate" id="filters">
                            <li><a class="current wow fadeInUp" href="#" data-filter=".illustration"
                                    data-wow-delay="0.2s">Сервисы и услуги</a></li>
                            <li><a class="wow fadeInUp" href="#" data-filter=".marketing" data-wow-delay="0.4s">Еда</a>
                            </li>
                            <li><a class="wow fadeInUp" href="#" data-filter=".photography"
                                    data-wow-delay="0.6s">Интересные места</a></li>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-self-stretch ftco-animate">
                                            <div class="media block-6 services d-block">
                                                ...
                                                <div class="media-body">
                                                    <h3 class="heading mb-3" style="padding-top: 10px">Такси в Сортавала
                                                    </h3>
                                                    <p>Иногда, во время отдыха в гостевом доме в Сортавала, хочется
                                                        остаться без личного автомобиля. Осмотреть
                                                        достопримечательности, поужинать в хорошей компании.<br><br>
                                                        Качественный отдых в загородном доме <b>«Сонный залив»</b>,
                                                        предполагает возможность отвлечься от ежедневных привычных
                                                        задач.<br><br>
                                                        Остались до глубокой ночи в купели на террасе, были в сауне и
                                                        бане, а утром нужно за руль? Это не всегда удобно.<br><br>
                                                        Хорошо, что под рукой есть телефоны городских служб
                                                        такси.<br><br>
                                                        Водители такси, которые знают; как быстро доехать <b>"Сортавала
                                                            - Рускеала"</b>, <b>"Сортавала - Чёрные камни"</b>,
                                                        <b>"Сортавала - Карельский зоопарк"</b>
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-self-stretch ftco-animate">
                                            <div class="media block-6 services d-block">
                                                ...
                                                <div class="media-body">
                                                    <h3 class="heading mb-3" style="padding-top: 10px">Кафе и ресторанов
                                                    </h3>
                                                    <p>Собрали для Вас список рекомендуемых к посещению ресторанов и
                                                        кафе в Карелии</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row d-flex">
                                            <div class="conf-btn" style="padding-bottom: 50px;"><a
                                                    href="/kafe-i-restorany" target="_blank"
                            ...
                            <div class="form-group">
                                <p>Нажимая на кнопку, я соглашаюсь на
                                    <a href="/policy" class="publicPolicy"
                                        style="text-decoration: underline;color: #999999;">обработку персональных
                                        данных</a>
                                </p>
                            </div>
                            <div class="form-group" style="text-align: center">
                                <button type="button" onclick="sendMessage()" class="btn btn-primary py-3 px-5"><i
                                        class="ion-ios-send"></i> Отправить письмо</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script defer type="text/javascript" src="js/t-datepicker.js?v=<?php echo VERSION['scripts']['datepicker']?>">
    </script>
    ...
    "@type": "WebPage",
    "url": "https://sonniyzaliv.ru/chernaya-zhemchuzhina",
    "name": "Черная жемчужина 80м2 - забронировать онлайн дом на базе в Сортавала до 6 гостей. С панорамными окнами на залив. Аренда коттеджа ",
