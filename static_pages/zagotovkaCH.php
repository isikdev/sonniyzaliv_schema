<?php
    ...
    $title = 'Спящий залив - гостевые дома  в Карелии | Сонный Залив Сортавала';
    $descr = 'Спящий залив дома в Сортавала, аренда спящий залив, база спящий залив, спящий залив Нукутталахти ул Центральная 60 58, Спящий залив Сортавала, мятный дом, зеленый дом, синий дом';
    $keywords = 'Спящий залив дома в Сортавала, аренда спящий залив, база спящий залив, спящий залив Нукутталахти ул Центральная 60 58, Спящий залив Сортавала, мятный дом, зеленый дом, синий дом, Сонный Залив, Сортавала снять дом, горный парк, снять дом Карелия, аренда дома Сортавала, катера Сортавала';
...
<!-- END nav -->
<main role="main">
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/houses/spyashiy-zaliv/vsedoma/back1.webp');" data-stellar-background-ratio="0.5">
      <div class="container">
          
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center" style="margin-top: 100px;">
              <h1 id="act-form" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Спящий залив - новые дома в Сортавала</h1>
        ...
        <div class="container">
            <div class="row d-flex">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
                    <h2 class="mb-4">Спящий Залив</h2>
                    <p>Информация, которая будет Вам полезна при выборе места для отдыха</p>
                </div>
            </div>
            <div class="col-md-12 heading-section ftco-animate">
                <p class="color-black">Новые гостевые дома расположились на острове Риекалансаари в поселке Нукутталахти (Соннный залив) на берегу пролива Ладоги в 4,5 километрах от цетра города Сортавала.</p>
                <p class="color-black">Дома стандарт и комфорт классов с теплыми полами, кондиционерами, посудомойками.
Компания до 8 гостей сможет с комфортом разместиться в любом доме. Двухуровневые кровати в спальных комнатах с качественными матрасами. </p>
                <div class="row d-flex pt-3 pb-5">
                     <div class="videoBackground" style="width: 438px; height: 1378px;"><video preload="auto" playsinline="" autoplay="" loop="" muted=""><source src="https://dl.dropbox.com/scl/fi/fkvmkezbraoamh0ihq7s2/output-compress-video-online.com.mp4?rlkey=le77xd2ppnr73vdfs8hkf3zc6&amp;st=1p58c5tv&amp;dl=0" type="video/mp4"></video></div>

                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/2.webp" alt="Спящий залив 2">
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/3.webp" alt="Спящий залив 3">
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/1.webp" alt="Спящий залив 14">
                    
                        <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/4.webp" alt="Спящий залив 4">
                            <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/5.webp" alt="Спящий залив 5">
                </div>
                <p class="color-black">Предлагаются дома нескольких размеров 70, 90, 120 квадратных метров в широком ценовом диапазоне для любого бюджета. Дома называются приятными цветами: зеленый дом, синий дом, мятный дом, дом капучино.</p>
              <div class="col-md-12 heading-section ftco-animate pt-5">
                <iframe width="340" height="620" src="https://www.youtube.com/embed/VwLx_1HivQs?si=WKOlc2nLesk4joNE" title="Видеообзор Спящий залив" frameborder="2" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
               </div>
                <p class="color-black">Отдельностоящий дом с мангальной зоной и видом на залив в распоряжении гостей. Теплые "ламповые" интерьеры согревают и расслабляют в любое время года. Дома работают круглый год.
Сауна в каждом доме располагает к комфортному отдыху от города. Просторные террасы с видом на закатный залив позволяют забыть о городском ритме и насладиться размеренным течением времени в Карелии.</p>
            </div>
            <div class="row d-flex">
            ...
            <div class="col-md-12 heading-section ftco-animate pt-5">
                <p class="color-black">Для малышей оборудована игровая площадка с детскими домиками, большими качелями.
Подход к воде с небольшим оборудованным пляжем находится всего в 300 метрах.</p>
                <div class="row d-flex pt-3 pb-5">
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/6.webp" alt="Спящий залив 6">
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/7.webp" alt="Спящий залив 7">     
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/8.webp" alt="Спящий залив 8"> 
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/9.webp" alt="Спящий залив 9"> 
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/10.webp" alt="Спящий залив 10"> 
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/11.webp" alt="Спящий залив 11"> 
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/12.webp" alt="Спящий залив 12"> 
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/13.webp" alt="Спящий залив 13"> 
                    <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/14.webp" alt="Спящий залив 14">   
                      <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/15.webp" alt="Спящий залив 15"> 
                        <img class="col-md-12 ftco-animate" src="images/houses/spyashiy-zaliv/vsedoma/16.webp" alt="Спящий залив 16"> 
                    
                </div>
            
                <p class="color-black">Возможно платное размещение с животными с разовым сбором. Возможна аренда лодок. Прогулки на катерах по Ладоге.
Диапазоны цен от 10.000 в межсезонье до 20.000 в высокий сезон. Новогодние праздники, как правило, дороже. Бронируют новый год с сентября, на летний сезон продажи открываются в декабре-январе.</p>
            </div>
                 <div class="row d-flex">
                <div class="conf-btn" style="padding-top: 5px;"><a href="#" <?/*id="reserve1" */?> data-tl-booking-open="true" class="btn btn-primary py-3 px-4 ftco-animate"><i class="ion-ios-calendar"></i> Забронировать</a></div>
            </div>
...
<script type="application/ld+json">{
    ...
    "@type": "WebPage",
    "url": "https://sonniyzaliv.ru/zagotovkaCH.php",
    "name": "Спящий залив - гостевые дома  в Карелии | Сонный Залив Сортавала",
    "description": "Спящий залив дома в Сортавала, аренда спящий залив, база спящий залив, спящий залив Нукутталахти ул Центральная 60 58, Спящий залив Сортавала, мятный дом, зеленый дом, синий дом",
    "inLanguage": "ru-RU",
    "publisher": {
        "@type": "Organization",
        "name": "Сонный Залив",
