<?php
	...
	$title = 'Восточный с камином - Просторный гостевой дом с камином в городе Сортавала. Аренда коттеджа посуточно в республике Карелия г. Сортавала';
	$descr = 'Мы предлагаем Вам снять дом "Восточный с камином" ср всеми удобствами в Карелии г. Сортавала. Арендовать коттедж "Восточный с камином" на сутки в республике Карелия на Сонный Залив. Уютный большой дом "Восточный с камином". Арендуйте дом "Восточный с камином" на сутки в республике Карелия по цене от 10000 тыс. руб. в сутки';
	$keywords = 'снять коттедж на сутки в республике Карелия, аренда коттеджа посуточно в республике Карелия, отдых в Карелии, снять дом в Сортавала';
...
<html lang="ru" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#" class="tl-html">
  <head>
	...
	<meta property="og:image" content="images/logo.png">
      <link rel="canonical" href="https://sonniyzaliv.ru/vostochniy"/>
...
<!--</script>-->
  ...
  <body>
    ...
    <main role="main">
		<div class="js-fullheight" id="main-photo" style="background: #f9fafb;">
            <div class="flexslider">
                <ul class="slides">
                    <li style="background-image: url(images/houses/vostochniy/1.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/vostochniy/7.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/vostochniy/6.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/vostochniy/12.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/vostochniy/13.webp);" data-stellar-background-ratio="0.5"></li>
                </ul>
                  ...
                  <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                      <div class="col-md-9 text text-center ftco-animate" style="margin-top: 100px;" data-scrollax=" properties: { translateY: '70%' }">
                         <h1 id="act-form" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Восточный с камином</h1>
                         <h2 class="subtext" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Аренда гостевого дома "Восточный с камином" в г. Сортавала. Актуальные цены, подробное описание, фотографии, контакты</h2>
                         <?php echo $iconBlock; ?>
                      </div>
            ...
            <div class="container">
                <div class="row d-flex">
                    <div class="col-md-6 d-flex">
                        <div class="img d-flex align-self-stretch" style="background-image:url(images/houses/vostochniy/16.webp);"></div>
                    </div>
                    <div class="col-md-6 pl-md-5 py-5">
                        <div class="row justify-content-start pb-3">
                            <div class="col-md-12 heading-section ftco-animate">
                                <h2 class="mb-4 text-center">Людмила - владелец "Восточный с камином"</h2>
                                <div class="col-md-12 justify-content-center counter-wrap ftco-animate" style="padding-top: 22px">
                                    <div class="block-18 text-center mb-4">
                                        <div class="text">
                                            <strong style="font-size: 22px; color: #323232;">"Предлагаю вашему вниманию просторный и уютный гостевой дом, с красивым камином в гостиной. Вблизи дома нет водоемов, т.к находится в самом городе Сортавала"</strong>
                                        </div>
                                    </div>
                                </div>
                                <p class="text-center"><b>Приветствую, в своем гостевом доме "Восточный с камином"!</b></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="conf-btn pt-50"><a href="#" <?/*id="reserve1" */?> data-tl-booking-open="true" class="btn btn-primary py-3 px-4 ftco-animate"><i class="ion-ios-calendar"></i> Забронировать</a></div>
                </div>
            </div>
        </section>
                            ...
                            <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                                <div class="media block-6 services d-block">
                                    ...
                                    <div class="media-body">
                                        <h3 class="heading mb-3">12 спальных мест</h3>
                                        <p>В доме расположены 12 спальных мест для вашего комфортного пребывания</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                                <div class="media block-6 services d-block">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>Возможно размещение 1 дополнительного места</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            ...
            <div class="container">
                <div class="row justify-content-center pb-4">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <p>Ниже ,представлены актуальные цены на бронирование гостевого дома "Восточный с камином"</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 ftco-animate">
                        <div class="project-wrap">
                            <a class="img scroll-elem" style="background-image: url(images/karelia-11.webp);"></a>
                            <div class="text p-4">
                                <span class="price">10000 руб/сут</span>
                                ...
                                <p class="location"><span class="flaticon-settings"></span> до 8 человек</p>
                                <p class="location"><span class="flaticon-settings"></span> Предоплата 20% от общей стоимости</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 ftco-animate">
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                <span class="price">15000 руб/сут</span>
                                <span class="days">от 1 суток</span>
                                <h3><a class="scroll-elem">"Лето"</a></h3>
                                <p class="location"><span class="flaticon-settings"></span> ночи: пн-пн</p>
                                <p class="location"><span class="flaticon-settings"></span> 8-12 человек</p>
                                <p class="location"><span class="flaticon-settings"></span> Предоплата 20% от общей стоимости</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 ftco-animate">
                        <div class="project-wrap">
                            <a class="img scroll-elem" style="background-image: url(images/karelia-8.webp);"></a>
                            <div class="text p-4">
                                <span class="price">от 10000 руб/сут</span>
                                <span class="days">от 1 суток</span>
                                <h3><a class="scroll-elem">"Будние и Выходные"</a></h3>
                                <p class="location"><span class="flaticon-settings"></span> ночи: пн-пн</p>
                                <p class="location"><span class="flaticon-settings"></span> до 8 человек</p>
                                <p class="location"><span class="flaticon-settings"></span> более 2 гостей + 1000 руб/сут за каждого</p>
                                <p class="location"><span class="flaticon-settings"></span> Предоплата 20% от общей стоимости</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 ftco-animate">
                        <div class="project-wrap">
                            ...
                            <div class="text p-4">
                                <span class="price">от 15000 руб/сут</span>
                                <span class="days">от 1 суток</span>
                                <h3><a class="scroll-elem">"Будние и Выходные"</a></h3>
                                <p class="location"><span class="flaticon-settings"></span> ночи: пн-пн</p>
                                <p class="location"><span class="flaticon-settings"></span> 8-12 человек</p>
            ...
            <div class="container">
                <div class="row d-flex">
                    <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
                        ...
                        <p>Хотите разнообразить свой отдых? Наполнить его яркими и незабываемыми впечатлениями? В таком случае, "Восточный с камином" рекомендуем обратить внимание на следующие предложения:</p>
                    </div>
                    <div class="col-md-12">
                        <div class="row">
        ...
        <section id="houseRules" class="ftco-section services-section pt-5 bg-light">
            <div class="container">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate" style="padding-top: 60px;">
                    ...
                    <p>Гостевой дом "Восточный с камином" предлагает Вам ознакомиться с <b>7-ю</b> основными правилами бронирования, пребывания, заезда и выезда:</p>
                </div>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                            <div class="media block-6 services d-block">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>1-й этаж до 8 человек</p>
                                    <p>Дом целиком - от 9 до 12 человек</p>
                                    <p>Если вы бронируйте только первый этаж,помимо вас в доме жить никто не будет,просто 2й этаж будет закрыт.</p>
                                    <p>Майские праздники дороже!</p>
                        ...
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                            <div class="media block-6 services d-block">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Время заезда и выезда можно скорректировать по договоренности</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                            <div class="media block-6 services d-block">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>С животными заселение за доп. плату</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
        ...
        <section id="houseReviews" style="background: url(images/houses/vostochniy/1.webp);" class="ftco-section services-section module bg-dark-60 pt-0 pb-0 parallax-bg testimonial ftco-animate">
            <div class="container">
        ...
        <section id="houseBooking" class="ftco-section ftco-no-pb pt-5 bg-light" style="background: #f9fafb; z-index: 1">
            <div class="container">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate" style="padding-top: 60px;">
                    ...
                    <p>Для бронирования гостевого дома "Восточный с камином" заполните форму ниже</p>
                </div>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <form action="#" class="search-property-1">
                                <div class="row">
                                        ...
                                        <div class="form-group" style="text-align: center;">
                                            ...
                                            <div class="sel sel--black-panther">
                                                <select name="select-profession" id="select-profession">
                                                    ...
                                                    <option value="10" name="select-profession-option">Восточный с камином</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg align-self-end">
                                        <div class="form-group">
                                            <div class="form-field">
                                                <button type="button" id="sendAppBtn" onclick="sendApplication(this)" hid="10" class="form-control btn btn-primary"><i class="ion-ios-checkmark-circle"></i> Забронировать</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
			...
			<div class="row d-flex contact-info">
			  <div class="col-md-3 d-flex ftco-animate">
				<div class="align-self-stretch box p-4 text-center">
					...
					<p>Россия, Республика Карелия, Сортавальское городское поселение, г. Сортавала, ул. Восточная, д. 32</p>
				  </div>
			  </div>
			  <div class="col-md-3 d-flex ftco-animate">
				<div class="align-self-stretch box p-4 text-center">
    ...
    "@type": "WebPage",
    "url": "https://sonniyzaliv.ru/vostochniy",
    "name": "Восточный с камином - Просторный гостевой дом с камином в городе Сортавала. Аренда коттеджа посуточно в республике Карелия г. Сортавала",
