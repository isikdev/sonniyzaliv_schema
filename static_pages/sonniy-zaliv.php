...
$title = 'Сонный Залив - снять гостевой дом в Карелии с панорамным видом на берегу озера. Аренда коттеджа "Сонный залив" посуточно в республике Карелия г. Сортавала';
$descr = 'Приезжайте в дом "Сонный залив" с сауной и купелью, панорамным видом на озеро в Карелии г. Сортавала. Арендовать коттедж "Сонный залив" на сутки в республике Карелия на Сонный Залив. Уютный большой дом "Сонный залив" на берегу озера. Арендуйте дом "Сонный залив" с панорамным видом на сутки в республике Карелия по цене от 7000 тыс. руб.';
$keywords = 'снять коттедж на сутки в республике Карелия, аренда коттеджа посуточно в республике Карелия, аренда дома с панорманым видом на озеро, отдых в Карелии, снять дом с видом на озеро, снять дом в Сортавала, аренда дома в Сортавала, база в Карелии, база в Сортавала, снять дачу в Сортавала, сауна, купель';
...
<head>
    ...
    <link rel="canonical" href="https://sonniyzaliv.ru/sonniy-zaliv"/>
    ...
    <link href="css/style.css?v=<?php echo VERSION['styles'] ?>" as="style" rel="preload"
          onload="this.rel='stylesheet'">
            ...
            <nav class="navbar" id="navbar">
                <ul class="menu">
                    ...
                    <li class="menu-item"><a href="<? /*#houseBooking*/ ?>#" data-tl-booking-open="true"
                                             data-tl-room='217718'>Забронировать</a></li>
                </ul>
            </nav>
        </div>
    </section>
...
<main role="main">
    <div class="js-fullheight" id="main-photo" style="background: #f9fafb;">
        <div class="flexslider">
            <ul class="slides">
                <li style="background-image: url(images/houses/sonniy-zaliv/house48.webp);"
                    data-stellar-background-ratio="0.5"></li>
                <li style="background-image: url(images/houses/sonniy-zaliv/house32.webp);"
                    data-stellar-background-ratio="0.5"></li>
                <li style="background-image: url(images/houses/sonniy-zaliv/house13.webp);"
                    data-stellar-background-ratio="0.5"></li>
                <li style="background-image: url(images/houses/sonniy-zaliv/house27.webp);"
                    data-stellar-background-ratio="0.5"></li>
                <li style="background-image: url(images/houses/sonniy-zaliv/house37.webp);"
                    data-stellar-background-ratio="0.5"></li>
            </ul>
                ...
                <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
                        ...
                        <div class="col-md-9 text text-center ftco-animate" style="margin-top: 100px;"
                            ...
                            <h1 id="act-form" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Сонный
                                Залив</h1>
                            <h2 class="subtext" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Аренда
                                гостевого дома "Сонный залив" в Карелии. Актуальные цены, подробное описание,
                                фотографии, контакты</h2>
                            <?php echo $iconBlock; ?>
                        </div>
            ...
            <div class="row d-flex" id="aboutUs">
                <div class="col-md-6 d-flex">
                    <div class="img d-flex align-self-stretch"
                         style="background-image:url(images/houses/sonniy-zaliv/house53.webp);"></div>
                </div>
                <div class="col-md-6 pl-md-5 py-5">
                    <div class="row justify-content-start pb-3">
                        <div class="col-md-12 heading-section ftco-animate">
                            <h2 class="mb-4">Александр - владелец "Сонный Залив"</h2>
                            <p class="fs-14"><b>Наша миссия:</b> поддерживать баланс между комфортной ценой для гостей и
                                комфортным семейным отдыхом в загородном доме на берегу пролива в уникальном, созданным
                                природой, месте.</p>
                            <p class="fs-14">Улучшаем качество отдыха для пар, небольших компаний и семей с детьми,
                                чтобы гости получали больше приятных эмоций от визитов в Карелию.</p>
                ...
                <div class="col-md-12 centered-text pt-50 heading-section pl-md-5 ftco-animate">
                    <p style="font-size: 22px; color: #323232; font-weight: bold;">Почему необходимо отдохнуть именно у
                        нас:</p>
                </div>
                <div class="col-md-12 d-flex">
                    <div class="row">
                        ...
                        <div class="col-md-12 justify-content-center counter-wrap ftco-animate"
                            ...
                            <div class="block-18 text-center mb-4">
                                <div class="text">
                                    <strong style="font-size: 22px; color: #f9ab30;">Появились вопросы? Свяжитесь со
                                        мной</strong>
        ...
        <div class="container">
            <div class="row d-flex">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
                    <p>Видео от наших подписчиков ВК</p>
                    <iframe src="https://vk.com/video_ext.php?oid=-212131932&id=456239042&hd=4&autoplay=1" width="390"
                            height="740"
                        ...
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                            <div class="media block-6 services d-block">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>5-е место обеспечиваем раскладным диваном-кроватью</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                        ...
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                            <div class="media block-6 services d-block">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Просмотр телевизора со спутниковым телевидением и выходом в интернет на мягком
                                        диване</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row d-flex">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
                    ...
                    <p>Чтобы Ваш отдых был еще более разнообразным и незабываемым, за дополнительную стоимость, мы
                        готовы Вам предоставить:</p>
                </div>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                        ...
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                            <div class="media block-6 services d-block">
                                ...
                                <div class="media-body">
                                    <h3 class="heading mb-3">Купель</h3>
                                    <p>Купель с подогревом, аква-массажем, подсветкой, фильтрацией чистым кварцем и
                                        ультрафиолетом</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="swiper-paid-options">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="ftco-animate">
                            <div class="project-destination">
                                <a class="img" style="background-image: url(images/houses/sonniy-zaliv/house40.webp);"
                                   href="images/houses/sonniy-zaliv/house40.webp" data-fancybox="gallery-paid-options">
                                    <div class="text">
                                        <h3>Лодка</h3>
                                    </div>
                                </a>
                    ...
                    <div class="swiper-slide">
                        <div class="ftco-animate">
                            <div class="project-destination">
                                <a class="img" style="background-image: url(images/houses/sonniy-zaliv/house36.webp);"
                                   href="images/houses/sonniy-zaliv/house36.webp" data-fancybox="gallery-paid-options">
                                    <div class="text">
                                        <h3>Купель</h3>
                                    </div>
                                </a>
                    ...
                    <div class="swiper-slide">
                        <div class="ftco-animate">
                            <div class="project-destination">
                                <a class="img" style="background-image: url(images/houses/sonniy-zaliv/house41.webp);"
                                   href="images/houses/sonniy-zaliv/house41.webp" data-fancybox="gallery-paid-options">
                                    <div class="text">
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="ftco-animate">
                            <div class="project-destination">
                                <a class="img" style="background-image: url(images/houses/sonniy-zaliv/house35.webp);"
                                   href="images/houses/sonniy-zaliv/house35.webp" data-fancybox="gallery-paid-options">
                                    <div class="text">
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="ftco-animate">
                            <div class="project-destination">
                                <a class="img" style="background-image: url(images/houses/sonniy-zaliv/house43.webp);"
                                   href="images/houses/sonniy-zaliv/house43.webp" data-fancybox="gallery-paid-options">
                                    <div class="text">
                                    </div>
                                </a>
                            </div>
        ...
        <div class="container">
            <div class="row d-flex">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
                    ...
                    <p>Хотите разнообразить свой отдых? Наполнить его яркими и незабываемыми впечатлениями? В таком
                        случае, рекомендуем обратить внимание на наши следующие предложения:</p>
                </div>
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12 d-flex align-self-stretch ftco-animate">
                            <div class="media block-6 services d-block">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Прогулки по Ладожским шхерам на комфортабельном 6-триместном катере. Капитан
                                        судна с опытом с 1998 года</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="swiper-services">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="ftco-animate">
                            <div class="project-destination">
                                <a class="img" style="background-image: url(images/houses/sonniy-zaliv/kater-1.webp);"
                                   href="images/houses/sonniy-zaliv/kater-1.webp" data-fancybox="gallery-boat">
                                    <div class="text">
                                        <h3>Катер</h3>
                                        <!-- <span>5 Tours</span> -->
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="ftco-animate">
                            <div class="project-destination">
                                <a class="img" style="background-image: url(images/houses/sonniy-zaliv/kater-2.webp);"
                                   href="images/houses/sonniy-zaliv/kater-2.webp" data-fancybox="gallery-boat">
                                    <div class="text">
                                        <!-- <span>5 Tours</span> -->
                                    </div>
                                </a>
                    ...
                    <div class="swiper-slide">
                        <div class="ftco-animate">
                            <div class="project-destination">
                                <a class="img" style="background-image: url(images/houses/sonniy-zaliv/kater-3.webp);"
                                   href="images/houses/sonniy-zaliv/kater-3.webp" data-fancybox="gallery-boat">
                                    <div class="text">
                                        <!-- <span>5 Tours</span> -->
                                    </div>
                                </a>
                    ...
                    <div class="swiper-slide">
                        <div class="ftco-animate">
                            <div class="project-destination">
                                <a class="img" style="background-image: url(images/houses/sonniy-zaliv/kater-4.webp);"
                                   href="images/houses/sonniy-zaliv/kater-4.webp" data-fancybox="gallery-boat">
                                    <div class="text">
                                        <!-- <span>5 Tours</span> -->
                                    </div>
                                </a>
                    ...
                    <div class="swiper-slide">
                        <div class="ftco-animate">
                            <div class="project-destination">
                                <a class="img" style="background-image: url(images/houses/sonniy-zaliv/kater-5.webp);"
                                   href="images/houses/sonniy-zaliv/kater-5.webp" data-fancybox="gallery-boat">
                                    <div class="text">
                                        <!-- <span>5 Tours</span> -->
                                    </div>
                                </a>
                    ...
                    <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block">
                            ...
                            <div class="media-body">
                                ...
                                <p>Поздний заезд с 19:00 до 0:00 и ранний выезд, до 7:00, обязательно обсуждаются
                                    заранее</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center pb-4">
                <div class="col-md-12 heading-section text-center ftco-animate">
                    ...
                    <p>Ниже, представлены некоторые интересные особенности гостевого дома "Сонный Залив"</p>
                </div>
            </div>
            <div class="row">
                <div class="post-wrap ftco-animate">
                    <div class="post-item">
                        <div class="item-content">
                            ...
                            <div class="item-body">
                                <p>Тёплая сауна в доме включена в стоимость</p>
                            </div>
                        </div>
                    </div>
                    <div class="post-item">
                    ...
                    <div class="post-item">
                        <div class="item-content">
                            ...
                            <div class="item-body">
                                <p>Для гостей-подписчиков ВК без автомобиля, трансфер из города к дому бесплатный.
                                    Подпишись- прокатись!</p>
                            </div>
                        </div>
                    </div>
                    <div class="post-item">
                        <div class="item-content">
                            ...
                            <div class="item-body">
                                <p>Тёплый, светлый, уютный, скандинавский интерьер дома с панорамными окнами, тёплыми
                                    полами и видом на залив</p>
                            </div>
                        </div>
                    </div>
                    <div class="post-item">
                        <div class="item-content">
                            ...
                            <div class="item-body">
                                <p>Своя безопасная, огороженная территория с местом для автомобиля. Один дом на участке.
                                    Сортавала аренда дома</p>
                            </div>
                        </div>
                    </div>
                    <div class="post-item">
                    ...
                    <div class="post-item">
                        <div class="item-content">
                            ...
                            <div class="item-body">
                                <p>Комфортное размещение для 4-х (+2) человек</p>
                            </div>
                        </div>
                    </div>
                    <div class="post-item">
            ...
            <div class="col-md-12 heading-section ftco-animate">
                <p class="color-black">Дом расположен на берегу Ладожского озера на большом острове,
                    в Ладожских шхерах в 10 минутах от туристического центра Сортавала. Рядом живописный сосновый лес с
                    грибами и ягодами.</p>
                <p class="color-black">Первый этаж: большая 20м2 уличная терраса, оборудованная для приготовления блюд
                    кухня-гостиная 23 м2,
                    спальня с двуспальной кроватью, финская сауна.</p>
                <p class="color-black">Второй этаж: большая комната с зоной отдыха , интересной библиотекой и
                    двуспальной кроватью, диван</p>
                <p class="color-black">Wi-fi. smart-TV с новинками кино, спутниковое телевидение 290 каналов, стабильный
                    интернет для работы и учебы,
                ...
                <p class="color-black">Тёплая купель на террасе (доступна каждый год с 1 мая по 1 ноября). Лодка на
                    берегу</p>
                <p class="color-black">До туристической изюминки Карелии - горного парка «Рускеала» 37 километров.
                    Карельский зоопарк для семейных прогулок - 56 км. Исторический парк "Бастион" - 10 минут на машине.
                    Встретим на вокзале.
                ...
                <p class="color-black">P.S. Наши гости любят чистоту и не хотят переплачивать за уборку. Поэтому у нас
                    два простых правила.
    ...
    <section id="houseReviews" style="background: url(images/houses/sonniy-zaliv/house44.webp);"
            ...
            <ul class="slides">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Понравилось очень! Спасибо за “все
                                    включено» банька Топили по 2 р на день. Джакузи на улице не воспользовались, но все
                                    впереди. Подумываем летом тоже вернуться!
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        ...
                                        <div class="testimonial-descr">27 декабря 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Спасибо, нам все очень понравилось и
                        ...
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Алена</div>
                                        <div class="testimonial-descr">24 декабря 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Отличное место для отдыха. На улице
                                    имеется джакузи.
                                </blockquote>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        ...
                                        <div class="testimonial-descr">26 ноября 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Отличный дом с отличной ценой , классные
                                    выходные
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Владислав</div>
                                        <div class="testimonial-descr">13 ноября 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Дом такой хороший как это можно себе
                                    представить! Обязательно берите шампанское! Купель ну очень романтичная!!! Спасибо
                                    хозяевам за чудесный отдых!
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        ...
                                        <div class="testimonial-descr">6 ноября 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Были в этом замечательном доме 17 августа
                                    -4 взрослых и двое деток.
                                    Все чистенько , выглаженное постельное белье аж хрустит от чистоты.
                                    Выполнено в современном стиле , для приготовления еды так же все есть .Хочу сказать
                                    что все продумано до мелочей .
                                    Купель это вообще огонь, вода нагрелась до 34 градусов, отличная сауна,».
                                    Кальян берите не пожалеете , если возьмёте за отдельную плату табак у хозяина дома (
                                    единственный табак от которого не болит голова).
                                    Всем рекомендую, нам понравилось все.
                                    Спасибо
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Светлана</div>
                                        <div class="testimonial-descr">2 ноября 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Отличное место, тихое место, озеро в
                                    шаговой доступности. Очень уютный светлый дом, есть все для комфортного отдыха.
                                    Очень порадовала теплая купель и сауна.
                                    Хозяин дома молниеносно реагировал на наши вопросы и пожелания) До Мраморного
                                    каньона и водопадов недалеко. Надеемся ещё вернуться)
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        ...
                                        <div class="testimonial-descr">20 октября 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Отличное место!!! Очень Тихое!
                                    Дом тёплый, в доме отличная купель в которой можно насладите тихим вечером, где вас
                                    не достанут звонки так как связь не очень ловит.
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Степан</div>
                                        <div class="testimonial-descr">25 сентября 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Очень понравилось тут отдыхать. Дом
                                    уютный, чистый. Есть все необходимое.
                                    Дополнительно брали купель с подогревом и подсветкой— не прогадали, проводили там
                                    вечера.
                                    Есть возможность взять в аренду лодку и много чего ещё. Хозяин доброжелательный и
                                    отзывчивый. Рекомендую!
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Виктория</div>
                                        <div class="testimonial-descr">22 сентября 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Шикарный дом. Спасибо большое за отдых.
                                    Всем будем рекомендовать.
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Вячеслав</div>
                                        <div class="testimonial-descr">22 августа 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Хороший дом, было все необходимое для
                                    проживания, даже всякие мелочи типа масла, приправ и т д.
                                    Отличная сауна) тихое, хорошее место
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Марина</div>
                                        <div class="testimonial-descr">18 августа 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Замечательное и красивое место! Погуляли,
                                    покатались на лодке, отдохнули в сауне и купели... Все супер!
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Дмитрий</div>
                                        <div class="testimonial-descr">11 августа 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Прекрасное место! Погуляли, покатались на
                                    лодках, отдохнули в сауне. Чудесный дом, спасибо внимательным хозяевам!
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        ...
                                        <div class="testimonial-descr">23 июля 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Спасибо большое за теплое отношение! Мы
                                    провели чудесные выходные у вас в гостевом доме.
                                    Купель просто супер) как и терраса. А виды со 2 этажа какие классные. Надеюсь,
                                    вернемся еще!
                                </blockquote>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        ...
                                        <div class="testimonial-descr">13 июля 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Отличное место, отдыхали с семьей. Фото
                                    соответствует действительности. Из неочевидных плюсов: нет соседей, тихо, все новое
                                    и рабочее. До города 10 минут, если не рассчитали продукты. Все дешевле чем в СПБ.
                                    Купель из допок советую брать, все время в нем тусовались. Хозяева приятные и
                                    пунктуальные. Про вид из панорамных окон писать буду, это топ! Все продумано до
                                    мелочей.
                                    Из минусов: интернет не очень, но там связь мобильная не ловит, поэтому на инет грех
                                    жаловаться, в зуме сможете работать, обрывов нет. Много слепней, запасайтесь
                                    средствами от комаров, но в основном они вечером. Не так много посуды для готовки
                                    если вы любитель есть много)
                                    В целом топовое место, всем советую
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Артур</div>
                                        <div class="testimonial-descr">8 июля 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Место шикарное!!! Дом так же, сделан с
                                    душой.
                                    Есть сауна, джакузи(грелась правда только до +30, но в ту жару это было только
                                    плюсом), кондиционер, присутствие интернета по wi-fi отдельно порадовало, и конечно
                                    же лодка!
                                    Доехать до достопримечательных мест типа «Рускеала» , «Водопадов» и.т.д советую до
                                    заезда в дом, и как можно раньше, так как народу там ближе к полудню очень много. Да
                                    и от этого места это не так уж и далеко.
                                    Вообщем крайне рекомендую, хозяева кстати весьма клиентоориентированны, на любые
                                    просьбы или замечания оперативно реагируют!!!

                                    P.S Советую запастись средством от слепней и комаров.
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Алексей</div>
                                        <div class="testimonial-descr">30 июня 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Это волшебное место! Большой комфортный
                                    светлый дом, запах дерева, головокружительный вид из окон.
                                    Тихо, спокойно - идеальное место для расслабленного отдыха и перезагрузки. Купель с
                                    пузырьками после сауны - кайф!
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Марина</div>
                                        <div class="testimonial-descr">22 июня 2021</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-8 offset-sm-2">
                                <blockquote class="testimonial-text font-alt">Гостили в «Сонном заливе» две ночи в июне.
                                    Шикарное место, классная природа. Очень понравилось, что всё в светлых тонах и
                                    пахнет деревом.
                                    Свежий дом, уютно. Остались приятные воспоминания. Спасибо Александру и Юлии
                                </blockquote>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4 offset-sm-4">
                                <div class="testimonial-author">
                                    <div class="testimonial-caption font-alt">
                                        <div class="testimonial-title">Игорь</div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-field">
                                            <button type="button" id="sendAppBtn" onclick="sendApplication(this)"
                                                    hid="3" class="form-control btn btn-primary"><i
...
<script type="application/ld+json">{
    ...
    "@type": "Product",
    "url": "https://sonniyzaliv.ru/sonniy-zaliv",
    "name": "Сонный Залив - снять гостевой дом в Карелии с панорамным видом на берегу озера. Аренда коттеджа ",
    "description": "Приезжайте в дом ",
    "inLanguage": "ru-RU",
    "offers": {
        "@type": "Offer",
        "priceCurrency": "RUB",
