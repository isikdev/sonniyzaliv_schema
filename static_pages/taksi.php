<?php
    ...
    $title = 'Сонный Залив - такси в Сортавала. Можно вызвать такси. Список служб такси города Сортавала по минимальным ценам, с описанием услуг и стоимости поездки';
    $descr = 'Вызвать такси в Сортавала, Сортавала Такси';
    $keywords = 'такси Сортавала, такси, такси дешево, такси Рускеала, номер такси Сортавала, вызвать такси Сортавала';
...
<head>
    ...
    <link rel="canonical" href="https://sonniyzaliv.ru/taksi"/>
    ...
    <section id="partnerTaxi" class="ftco-section services-section bg-light ftco-no-pb">
        <div class="container">
            <div class="row d-flex">
               ...
               <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate">
 <a href="https://wa.me/79215223455"style="font-family:times new roman;color:black;font-size:20px">Клик Whatsapp - заказ такси на сегодня или на любую более позднюю дату . Диспетчер и водители на связи с 09:00 до 20:00. Ночью не ездим</a> </div>
                        ...
                        <div class="col-md-12 d-flex align-self-stretch ftco-animate">
                            <div class="media block-6 services d-block">
                                ...
                                <div class="media-body">
                                    ...
                                    <p style="color: #443e70;font-weight: 700; text-align: left"><i style="color: #ff5154;" class="icon-phone_android"></i> <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                            <div class="media block-6 services d-block">
                                <div class="icon"><span class="icon-local_taxi"></span></div>
                                <div class="media-body">
                                    <h3 class="heading mb-3" style="padding-top: 10px; color: #813333;">"Движок"</h3>
                                    <p style="color: #443e70;font-weight: 700; text-align: left"><i style="color: #ff5154;" class="icon-phone_android"></i> <br>
                                        <i style="color: #ff5154;" class="icon-car"></i> Иномарки и отеч.<br>
                                        <i style="color: #ff5154;" class="icon-clock-o"></i> Круглосуточно<br>
                                        <i style="color: #ff5154;" class="icon-ruble"></i> Звоните
                        ...
                        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
                            <div class="media block-6 services d-block">
                                <div class="icon"><span class="icon-local_taxi"></span></div>
                                <div class="media-body">
                                    <h3 class="heading mb-3" style="padding-top: 10px; color: #813333;">"Фаворит"</h3>
                                    <p style="color: #443e70;font-weight: 700; text-align: left"><i style="color: #ff5154;" class="icon-phone_android"></i> <br>
                                        <i style="color: #ff5154;" class="icon-car"></i> Иномарки и отеч.<br>
                                        <i style="color: #ff5154;" class="icon-clock-o"></i> Круглосуточно<br>
                                        <i style="color: #ff5154;" class="icon-ruble"></i> Звоните
...
<script type="application/ld+json">{
    ...
    "@type": "WebPage",
    "url": "https://sonniyzaliv.ru/taksi",
    "name": "Сонный Залив - такси в Сортавала. Можно вызвать такси. Список служб такси города Сортавала по минимальным ценам, с описанием услуг и стоимости поездки",
    "description": "Вызвать такси в Сортавала, Сортавала Такси",
    "inLanguage": "ru-RU",
    "publisher": {
        "@type": "Organization",
        "name": "Сонный Залив",
