<?php 
	...
	$title = 'Черная жемчужина Барн - гостевой дом на базе отдыха на берегу озера в республике Карелия. Аренда коттеджа Черная жемчужина Барн посуточно в республике Карелия г. Сортавала';
	$descr = 'Новый дом у воды Черная жемчужина Барн с видом на озеро и всеми удобствами в Карелии г. Сортавала. Арендовать коттедж Черная жемчужина Барн на сутки в республике Карелия на Сонный Залив. Уютный большой дом Черная жемчужина Барн на берегу озера. Арендуйте дом Черная жемчужина Барн возле озера на сутки в республике Карелия по цене от 6500 тыс. руб.';
	$keywords = 'снять коттедж на сутки в республике Карелия, Черная жемчужина Сортавала, аренда коттеджа посуточно в республике Карелия, аренда дома с видом на озеро, отдых в Карелии, снять дом с видом на озеро, снять дачу сортавала 2024, дом с лодками';
...
<script>
  ...
  <body>
		...
		<div class="js-fullheight" id="main-photo">
            <div class="flexslider">
                <ul class="slides">
                    ...
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina-4/zima/3.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina-4/zima/2.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina-4/4.webp);" data-stellar-background-ratio="0.5"></li>
                    <li style="background-image: url(images/houses/chernaya-zhemchuzhina-4/3.webp);" data-stellar-background-ratio="0.5"></li>
                </ul>
                  ...
                  <div class="container">
                    <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                      <div class="col-md-9 text text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                         ...
                         <h1 id="act-form" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">"Черная жемчужина Барн"</h1>
                         <h2 class="subtext" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Аренда гостевого дома "Черная жемчужина Барн" в Карелии. Актуальные цены, подробное описание, фотографии, контакты</h2>
                         <?php echo $iconBlock; ?>
                      </div>
                            ...
                            <div class="col-md-12 heading-section ftco-animate">
                                ...
                                <div class="col-md-12 justify-content-center counter-wrap ftco-animate" style="padding-top: 22px">
                                    <div class="block-18 text-center mb-4">
                                        <div class="text">
                                            <strong style="font-size: 22px; color: #323232;">"Будем рады встретить гостей в новом туристическом уголке "Черная жемчужина ". Лес, Ладога, лодки, снегоходы. Уютные, теплые дома ждут вас</strong>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row justify-content-center pb-4">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <p>Ниже, представлены актуальные цены на бронирование гостевого дома "Черная жемчужина Барн"</p>
                    </div>
                </div>
                <div class="row">
        ...
        <section id="houseBooking" class="ftco-section ftco-no-pb ftco-no-pt bg-light" style="background: #f9fafb; z-index: 1">
            <div class="container">
                <div class="col-md-12 centered-text pb-5 heading-section pl-md-5 ftco-animate" style="padding-top: 60px;">
                    ...
                    <p>Для бронирования гостевого дома "Черная жемчужина Барн" заполните форму ниже</p>
                </div>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <form action="#" class="search-property-1">
                                <div class="row">
                                        ...
                                        <div class="form-group" style="text-align: center;">
                                            ...
                                            <div class="sel sel--black-panther">
                                                <select name="select-profession" id="select-profession">
                                                    ...
                                                    <option value="15" name="select-profession-option">Черная жемчужина Барн</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg align-self-end">
                                        <div class="form-group">
                                            <div class="form-field">
                                                <button type="button" id="sendAppBtn" onclick="sendApplication(this)" hid="15" class="form-control btn btn-primary"><i class="ion-ios-checkmark-circle"></i> Забронировать</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    "@type": "WebPage",
    "url": "https://sonniyzaliv.ru/chernaya-zhemchuzhina-4.php",
    "name": "Черная жемчужина Барн - гостевой дом на базе отдыха на берегу озера в республике Карелия. Аренда коттеджа Черная жемчужина Барн посуточно в республике Карелия г. Сортавала",
    "description": "Новый дом у воды Черная жемчужина Барн с видом на озеро и всеми удобствами в Карелии г. Сортавала. Арендовать коттедж Черная жемчужина Барн на сутки в республике Карелия на Сонный Залив. Уютный большой дом Черная жемчужина Барн на берегу озера. Арендуйте дом Черная жемчужина Барн возле озера на сутки в республике Карелия по цене от 6500 тыс. руб.",
    "inLanguage": "ru-RU",
    "publisher": {
        "@type": "Organization",
        "name": "Сонный Залив",
